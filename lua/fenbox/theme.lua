...
function M.setup(config)
  ...
  theme.base = {
    ...
    ["@keyword.conditional"] = { fg = c.red, style = config.keyword_style },
    ["@keyword.repeat"] = { fg = c.red, style = config.keyword_style },
    ["@keyword.directive.define"] = { fg = c.red, style = config.keyword_style },
    ["@keyword.directive"] = { fg = c.red, style = config.keyword_style },
    ...
    ["@markup.raw.markdown_inline"] = { fg = c.light_blue, bg = c.background_light },
    ...
    NvimTreeSymLink = { fg = c.light_blue, style = "italic" },
    ...
    BufferLineBackground = { fg = c.comment, bg = c.background_dark },
    BufferLineTabSelected = { fg = c.foreground, bg = c.background },
